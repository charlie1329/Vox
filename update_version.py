...
def main():
  ...
  plistpath = scriptpath + "/resources/Vox-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vox-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vox-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vox-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vox-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Vox-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Vox.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Vox.iss",inplace=1):
